            ...
            <div className="navbar-start ">
                <div className="dropdown lg:hidden ">
                    ...
                    <ul
                        ...
                        {
                            user && <NavLink to="/" className="px-2.5 py-1.5   hover:text-white rounded-md hover:bg-gray-400">Add Visa</NavLink>
                        }
                        {
                            user && <NavLink to="/" className="px-2.5 py-1.5   hover:text-white rounded-md hover:bg-gray-400">My added Visas</NavLink>
                        }
                        {
                            user && <NavLink to="/" className="px-2.5 py-1.5   hover:text-white rounded-md hover:bg-gray-400">My Visa Application</NavLink>
                        }
            ...
            <div className="navbar-end">
...

                {
                    user ? <div className="flex gap-2 sm:gap-4 items-center">
                        ...
                        <Link className="px-3 py-2 bg-[#ff6392] text-white font-bold rounded-lg hover:text-[#ff6392] hover:outline outline-[#ff6392] hover:bg-white text-sm" to="/logout">Logout</Link>
